...
func init() {
	...
	promptCmd.Flags().String("importance", "", "routing importance: low|medium|high|critical (default: medium)")
	promptCmd.Flags().String("deadline", "", "routing deadline: immediate|normal|background (default: normal)")
